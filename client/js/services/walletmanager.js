'use strict';
app.service("WalletManager", function(LocalStorage,Wallet) {
	...
	this.addWallet = function (wallet) {
		LocalStorage.saveWallet(wallet, this.walletCounter);
	...
	this.update = function(index) {
		LocalStorage.saveWallet(this.wallets[index], index);
	};
	...
	this.removeWallet = function (index) {    
		if(index in this.wallets && this.wallets[index] != null)
		{
			...
			LocalStorage.updateWallets(this.wallets);
			return true;
		}
		return false;
	};
